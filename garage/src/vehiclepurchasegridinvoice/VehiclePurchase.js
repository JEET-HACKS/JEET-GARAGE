	                   	           ...
	                   	           <div className="container-fluid">
	                   	                <div className="row">
	                   	                    ...
	                   	                    <div className="col-md-3">
	                   	                         ...
	                   	                         <input type="text" name="OrderNo"  onChange={selectionChange} className="form-control"/>
	                   	                    </div>
	                   	                </div>
	                   	                ...
	                   	                <div className="row">
	                   	                    ...
	                   	                    <div className="col-md-3">
	                   	                         ...
	                   	                         <input type="text" name="TransporterName"  onChange={selectionChange} className="form-control"/>
	                   	                    </div>
	                   	                    <div className="col-md-3">
	                   	                         <label>Driver Name</label>
	                   	                         <input type="text" name="DriverName"  onChange={selectionChange} className="form-control"/>
	                   	                    </div>
	                   	                    <div className="col-md-3">
	                   	                ...
	                   	                <div className="row">
	                   	                       <div className="col-md-3">
	                   	                            <label>Qty</label>
	                   	                            <input type="text" name="Qty"  onChange={ChangeQty} className="form-control bg-light"/>
	                   	                      </div>
	                   	                      <div className="col-md-3">
	                   	             ...
	                   	             {/*  <div className="row mt-3">
	                   	                ...
	                   	                */} 
	                   	                ...
	                   	                <div className="row">
	                   	                    ...
	                   	                    <div className="col-md-3">
	                   	                         <label>Cess%</label>
	                   	                         <input type="text" name="CessPer" onChange={(e)=>CessChange(e)} className="form-control"/>
	                   	                    </div>
	                   	                    <div className="col-md-3">
	                   	                ...
	                   	                <div className="row">
	                   	                    <div className="col-md-3">
	                   	                         <label>TCS%</label>
	                   	                         <input type="text" name="TcsPer" onChange={(e)=>TcsChange(e)} className="form-control"/>
	                   	                    </div>
	                   	                    <div className="col-md-3">
